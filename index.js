...
function regex_convertor(string, add, worker) {
    ...
    return `${protocol[1]}://${uuid[1]}@${add}:${port[1]}?sni=${worker}&allowInsecure=1&fp=random&alpn=h2,http/1.1&security=${security[1]}&type=${type[1]}&path=/${host[1]}${path[1]}&host=${worker}#${name[1]}`
